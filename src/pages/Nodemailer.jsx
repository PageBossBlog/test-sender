...
const Nodemailer = () => {
  ...
  const MAX_SMTP_CONFIGURATIONS = 1;
  ...
  const addNewSMTP = (event) => {
    ...
    if (smtpConfigurations.length < MAX_SMTP_CONFIGURATIONS) {
      ...
      toast.error("Maximum limit of SMTP configurations reached (1)");
    }
  };
  ...
  const handleGenerateChange = (event) => {
    setNumberOfEmails(parseInt(event.target.value, 10));
  };

  const generate = () => {
    if (numberOfEmails > 10000) {
      toast.error("Cannot generate more than 10,000 emails");
      return;
    }
    ...
    const emails = generateRandomEmails(numberOfEmails);
    downloadCSV(emails);
  ...
  const downloadCSV = (data) => {
    ...
    link.setAttribute("download", "random_emails.csv");
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        if (validateEmails(emailArray)) {
            if (emailArray.length > 400) {
            toast.error("You can only upload 400 emails");
            return;
          }
  ...
  const handleAttachmentUpload = async (event) => {
    ...
    reader.onload = (e) => {
      ...
      // Save file data and filename in localStorage
  ...
  const sendEmail = async (e) => {
    ...
    try {
      const toastId = toast.loading(
        `Sending letter to ${emailCount.toLocaleString()} emails...`
      );
      ...
      <div className="w-full">
        ...
        <div className="-mt-2 lg:-mt-2">
          ...
          <div className="mt-10 border-t-2 border-blue-700 rounded-lg">
            <div className="relative overflow-hidden bg-white shadow-md dark:bg-white sm:rounded-lg">
              <div className="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div className="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                  <button
                    ...
                    className="flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
              ...
              <div className="relative p-4 bg-white rounded-lg shadow dark:bg-white sm:p-5">
                ...
                <form>
                  ...
                  <button
                    type="submit"
                    onClick={addNewSMTP}
                    className="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-4"
                  >
                    Add new SMTP
                  </button>
                </form>
                  ...
                  <div className="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      >
                        <option defaultValue={selectedRow?.port}>
                          {selectedRow?.port}
                        </option>
                        <option value="25">25</option>
                        <option value="587">587</option>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <select
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      >
                        <option defaultValue={selectedRow?.security}>
                          {selectedRow?.security}
                        </option>
                        <option value="Auto">Auto</option>
                        <option value="STARTTLS">STARTTLS</option>
                        <option value="SLS/TLS">SSL/TLS</option>
                        <option value="">None</option>
                      </select>
                    </div>
                  </div>
            ...
            <div className="col-span-2">
              <div className="items-center justify-center w-full h-full">
                <div className="relative w-full h-full mt-14">
                  <div className="flex flex-row items-stretch items-center justify-end flex-shrink-0 w-auto space-x-3 space-y-0 sm:w-auto md:w-auto sm:flex-row md:flex-row sm:space-y-0 md:space-y-0 sm:items-center md:items-center sm:space-x-3 md:space-x-3">
                    <input
                      type="number"
                      name="emails"
                      id="emails"
                      ...
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm w-[290px] rounded-lg focus:ring-blue-600 focus:border-blue-600 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 p-2 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="Generate test emails (max. 10,000)"
                    />
                    <button
                      type="button"
                      onClick={generate}
                      ...
                      <div className="grid gap-4 pt-8 mb-4 sm:grid-cols-2">
                        ...
                        <button
                          ...
                          className={`${
                            isAttachmentOpen
                              ? "hidden"
                              : "max-w-[250px] text-gray-900 mt-6 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-3 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2"
                          }`}
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div
                          className={`${
                            isAttachmentOpen ? "pt-4 sm:col-span-2 " : "hidden"
                          }`}
                        >
                          <label
                            htmlFor="content"

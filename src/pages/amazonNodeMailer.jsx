...
"smtpConfigurations",
  ...
  const sendEmail = async (e) => {
    ...
    const emailArray = smtpConfigurations.map(config => config.email);
    ...
    try {
      ...
      if (errorMessage.includes("SSL routines:ssl3_get_record:wrong version number")) {
        toast.error(`You need to use security "Tls" for your SMTP.`, {
          duration: 90000,
        });
      } else if (errorMessage.includes("SMTP error: 452")) {
        toast.error("SMTP server has reached its usage limit. Please try again later.", {
          duration: 90000,
        });
      } else {
                  ...
                  <div className="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                      <label
                        ...
                        className="block mb-2 text-sm font-medium text-gray-900 "
                      >
                        Email <span className="italic text-gray-500">(your amazon verified identity)</span>
                      </label>
                      <input
                        type="text"
                        name="email"
                ...
                <div className="relative w-full h-full mt-14">
                  <div className="flex flex-row items-stretch items-center justify-end flex-shrink-0 w-auto space-x-3 space-y-0 sm:w-auto md:w-auto sm:flex-row md:flex-row sm:space-y-0 md:space-y-0 sm:items-center md:items-center sm:space-x-3 md:space-x-3">
                    <input
                      ...
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm w-[290px] rounded-lg focus:ring-blue-600 focus:border-blue-600 block    p-2   "
                      ...
                      <div className="grid gap-4 pt-8 mb-4 sm:grid-cols-2">
                        ...
                        <button
                          ...
                          className={`${
                            isAttachmentOpen
                              ? "hidden"
                              : "max-w-[250px] text-gray-900 mt-6 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-3 text-center inline-flex items-center  me-2 mb-2"
                          }`}
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
